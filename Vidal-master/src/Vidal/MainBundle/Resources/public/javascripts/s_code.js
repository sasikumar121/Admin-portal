...
s.linkInternalFilters="javascript:,www.vidal.ru"
...
function s_doPlugins(s) {
    ...
    s.getUserSegment("us_sm");
    s.prop1=s.getNewRepeat(90); //3 months
    s.prop2=s.getDaysSinceLastVisit();
    s.prop3=s.getTimeParting('h','+0'); // Set hour
    s.prop4=s.getTimeParting('d','+0'); // Set day
    s.prop5=s.getTimeParting('w','+0'); // Set Weekend / Weekday
